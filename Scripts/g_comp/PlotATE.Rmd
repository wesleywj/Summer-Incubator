...
```{r}
df_risk_ratio_adl_no_cohabit_no_child
```
...
```{r}
pdf("N:/Incubator2025_ComputationalLifeCourse/Results/ate_adl_ref_ft_w_child.pdf", width = 20, height = 10)
grid.arrange(p_raw_ate_adl, p_std_ate_adl, p_risk_ratio_adl, nrow = 1, ncol = 3)
dev.off()
```

  
```{r}
pdf("N:/Incubator2025_ComputationalLifeCourse/Results/ate_depress_ref_ft_w_child.pdf", width = 20, height = 10)
grid.arrange(p_raw_ate_depress, p_std_ate_depress, p_risk_ratio_depress, nrow = 1, ncol = 3)
dev.off()
```

```{r}
pdf("N:/Incubator2025_ComputationalLifeCourse/Results/ate_self_rated_ref_ft_w_child.pdf", width = 20, height = 10)
grid.arrange(p_raw_ate_self_rated, p_std_ate_self_rated, p_risk_ratio_self_rated, nrow = 1, ncol = 3)
dev.off()
```


```{r}
pdf("N:/Incubator2025_ComputationalLifeCourse/Results/risk_ratio_ref_ft_w_child.pdf", width = 15, height = 10)
grid.arrange(p_risk_ratio_adl, p_risk_ratio_depress, p_risk_ratio_self_rated, nrow = 1, ncol = 3)
dev.off()
```
